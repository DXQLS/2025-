...
def excel_to_sql(excel_file_path, bas_deduction_rule_id, medicine_type):
    ...
    field_mapping = {
        ...
        '通用名称': {'sql_col': 'common_name', 'default': "''"},
        '剂型': {'sql_col': 'dosage_form', 'default': "''"},
        '包装单位': {'sql_col': 'unit', 'default': "''"},
        '费用等级': {'sql_col': 'fee_level', 'default': "'0'"},
        '通用比例': {'sql_col': 'common_ratio', 'default': "'0.0000'"},
...
if __name__ == "__main__":
    # =============== 在这里修改你的参数 ===============
    EXCEL_FILE_PATH = "安徽省阜阳目录亿保2024-药品库 (1).xls"  # 替换为你的Excel文件路径
    BAS_DEDUCTION_RULE_ID = "6"  # 替换为你的扣除规则ID
    MEDICINE_TYPE = "1"  # 替换为你的药品类型
    # =================================================
